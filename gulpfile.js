...
// Project related.
var project                 = 'php-project'; // Project Name.
var projectURL              = 'localhost/php-project'; // Project URL. Could be something like localhost:8888.
...
// Style related.
var styleSRC                = './styles/main.scss'; // Path to main .scss file.
var styleDestination        = './dist/styles/'; // Path to place the compiled CSS file.
// Defualt set to root folder.

// JS Vendor related.
var jsVendorSRC             = './scripts/vendor/*.js'; // Path to JS vendor folder.
var jsVendorDestination     = './dist/scripts/vendor'; // Path to place the compiled JS vendors file.
var jsVendorFile            = 'vendors'; // Compiled JS vendors file name.
// Default set to vendors i.e. vendors.js.

// JS Custom related.
var jsCustomSRC             = './scripts/*.js'; // Path to JS custom scripts folder.
var jsCustomDestination     = './dist/scripts/'; // Path to place the compiled JS custom scripts file.
...
var vendorJSWatchFiles      = './scripts/vendor/*.js'; // Path to all vendor JS files.
var customJSWatchFiles      = './scripts/*.js'; // Path to all custom JS files.
